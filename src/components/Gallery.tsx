...
export default function Gallery({ onInquire, artworksList }: GalleryProps) {
  ...
  const openLightbox = (art: Artwork) => {
    ...
    if (art.collection === 'laminas') {
      setSelectedSize('A4 (21 x 29.7 cm)');
    } else {
  ...
  const handleInquirySubmit = () => {
    if (activeArtwork) {
      ...
      if (activeArtwork.collection !== 'originales' && activeArtwork.collection !== 'laminas') {
              ...
              <div className="grid grid-cols-1 md:grid-cols-12">
                ...
                <div className="md:col-span-6 p-8 sm:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    {activeArtwork.description && activeArtwork.description.trim() ? (
